...
ui <- 
    ...
    HTML(paste0("Using code from ",  
                a(" @JonMinton", href="https://github.com/JonMinton/COVID-19", target = "_blank"), " and ", 
                ...
                a(" @JHUSystems Coronavirus data", href="https://github.com/CSSEGISandData/COVID-19", target = "_blank"), ".",
                "<BR>Growth line and Min number of cases ideas from" , a(" @nicebread303", href="https://github.com/nicebread/corona", target = "_blank"))),
...
server <- function(input, output) {
    ...
    growth_line = reactive({
        ...
        tibble(value = cumprod(c(input$min_n, rep((100 + input$growth)/100, max(final_df()$days_after_100, na.rm = TRUE)))),
               days_after_100 = 0:max(final_df()$days_after_100, na.rm = TRUE))
    })
